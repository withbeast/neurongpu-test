...
pkgdatadir = $(datadir)/neurongpu
pkgincludedir = $(includedir)/neurongpu
pkglibdir = $(libdir)/neurongpu
pkglibexecdir = $(libexecdir)/neurongpu
...
am__aclocal_m4_deps = $(top_srcdir)/m4/acx_mpi.m4 \
	$(top_srcdir)/m4/ct_check_cuda.m4 $(top_srcdir)/m4/libtool.m4 \
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(python_PYTHON) $(am__DIST_COMMON)
...
libneurongpu.so_LIBADD =
libneurongpu.so_SOURCES = libneurongpu.c
libneurongpu.so_OBJECTS = libneurongpu.lo
AM_V_lt = $(am__v_lt_$(V))
...
am__v_CCLD_1 = 
SOURCES = libneurongpu.c
DIST_SOURCES = libneurongpu.c
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	$(top_srcdir)/m4/py-compile COPYING INSTALL m4/compile \
...
ACLOCAL = ${SHELL} /media/dkb/data/google_drive/projects/NeuronGPU/m4/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /media/dkb/data/google_drive/projects/NeuronGPU/m4/missing autoconf
AUTOHEADER = ${SHELL} /media/dkb/data/google_drive/projects/NeuronGPU/m4/missing autoheader
AUTOMAKE = ${SHELL} /media/dkb/data/google_drive/projects/NeuronGPU/m4/missing automake-1.15
AWK = mawk
CC = gcc
CCDEPMODE = depmode=gcc3
CDINCPATH = -I/usr/local/cuda/include
CDLIBPATH = -L/usr/local/cuda/lib64
CFLAGS = -g -O2
CPP = gcc -E
CPPFLAGS = 
CXX = g++
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /media/dkb/data/google_drive/projects/NeuronGPU/m4/missing makeinfo
MANIFEST_TOOL = :
...
MPI_CXXLIBS = -pthread -L/usr/lib/x86_64-linux-gnu/openmpi/lib -lmpi_cxx -lmpi
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE = neurongpu
PACKAGE_BUGREPORT = 
PACKAGE_NAME = neurongpu
PACKAGE_STRING = neurongpu 1.6.2
PACKAGE_TARNAME = neurongpu
PACKAGE_URL = 
...
STRIP = strip
VERSION = 1.6.2
abs_builddir = /media/dkb/data/google_drive/projects/NeuronGPU
abs_srcdir = /media/dkb/data/google_drive/projects/NeuronGPU
abs_top_builddir = /media/dkb/data/google_drive/projects/NeuronGPU
abs_top_srcdir = /media/dkb/data/google_drive/projects/NeuronGPU
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /media/dkb/data/google_drive/projects/NeuronGPU/m4/install-sh
...
pdfdir = ${docdir}
pkgpyexecdir = ${pyexecdir}/neurongpu
pkgpythondir = ${pythondir}/neurongpu
prefix = /usr/local
...
ngpu_h_files = \
$(top_srcdir)/src/iaf_psc_exp_g.h \
$(top_srcdir)/src/iaf_psc_exp_hc_params.h \
$(top_srcdir)/src/iaf_psc_exp_hc.h \
$(top_srcdir)/src/iaf_psc_exp.h \
...
ngpu_src_files = \
$(top_srcdir)/src/iaf_psc_exp_g.cu \
$(top_srcdir)/src/iaf_psc_exp_hc.cu \
$(top_srcdir)/src/iaf_psc_exp.cu \
...
CUDA_FLAGS = -arch sm_61 --ptxas-options=-v --maxrregcount=55 --relocatable-device-code true
CUDA_LIBS = -lm -lcurand
lib_LTLIBRARIES = libneurongpu.so
all: config.h
...
installdirs:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(pythondir)"; do \
...
uninstall-am: uninstall-libLTLIBRARIES uninstall-pythonPYTHON
...
.PHONY: CTAGS GTAGS TAGS all all-am am--refresh check check-am clean \
	...
	install-ps install-ps-am install-pythonPYTHON install-strip \
...
libneurongpu.so: $(ngpu_src_files) $(ngpu_h_files)
