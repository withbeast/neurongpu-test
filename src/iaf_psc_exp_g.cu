...
// adapted from:
// https://github.com/nest/nest-simulator/blob/master/models/iaf_psc_exp_g.cpp
...
__global__ void iaf_psc_exp_g_Calibrate(int n_node, float *param_arr,
				      int n_param, float h)
{
...
__global__ void iaf_psc_exp_g_Update(int n_node, int i_node_0, float *var_arr,
...
int iaf_psc_exp_g::Calibrate(float, float time_resolution)
{
  iaf_psc_exp_g_Calibrate<<<(n_node_+1023)/1024, 1024>>>
